...
class MergeIndexTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  test("Verify correctness of index merge sdv") {
    ...
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "0") == 0)
  ...
  test("Verify command of index merge  sdv") {
    ...
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "0") == 0)
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "1") == 0)
  ...
  test("Verify index index merge with compaction  sdv") {
    ...
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "0") == 0)
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "1") == 0)
    assert(getMergedIndexFileCount("default", "carbon_automation_nonmerge", "2") == 0)
